  ...
  <div class="container">
    <form action="/categories/edit/{{ $category->id }}" method="post">
      ...
      <div class="mb-3 mt-3">
        ...
        <input type="text" class="form-control" placeholder="نام دسته بندی را وارد نمایید" name="categoryName" value="{{$category->categoryName}}" />
      </div>

      <div class="mb-3 mt-3">
        <label for="orderNumber" class="form-label">توضیحات:</label>
        <input type="text" class="form-control" placeholder="توضیحات را وارد نمایید" name="description" value="{{$category->description}}" />
      </div>
